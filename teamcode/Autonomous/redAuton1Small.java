...
@Autonomous(name="redAuton1Small")

public class redAuton1Small extends LinearOpMode {
...
//TODO eat apple pie
        davidDrive(DRIVE_SPEED,  -20,  20, 20, -20, true);
...
//        davidDrive(DRIVE_SPEED,-6,-6,-6,-6,true);
//        sleep(100);
        davidDrive(DRIVE_SPEED,14,-14,-14,14,true);
        davidDrive(TURN_SPEED,-2,2,-2,2,true);
        if (Zone == 1) {
            davidDrive(1, -22, -22, -22, -22, true);
        }
        if (Zone == 2) {
